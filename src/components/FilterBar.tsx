    ...
    <div className="p-3 space-y-3 border-b border-gray-700">
      ...
      <div className="relative" ref={wrapperRef}>
        ...
        <input
          ...
          className="w-full bg-gray-700/50 border border-gray-600 rounded-xl pl-10 pr-8 py-2 text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/40 outline-none transition-all"
        />
        {query && (
          <button
            onClick={() => {
          ...
          <div className="absolute top-full left-0 right-0 mt-1.5 bg-gray-850 border border-gray-700 rounded-xl shadow-2xl z-50 max-h-72 overflow-y-auto animate-scale-in custom-scrollbar" style={{ backgroundColor: '#1e2433' }}>
            ...
            {(locationResults.length > 0 || searching) && (
              <div>
                ...
                {searching ? (
                  <div className="flex items-center gap-2 px-3.5 py-2.5 text-xs text-gray-500">
      ...
      <div className="flex flex-wrap gap-2">
        <select
          ...
          className="bg-gray-700/50 border border-gray-600 rounded-lg px-3 py-1.5 text-xs text-gray-300 outline-none focus:ring-1 focus:ring-blue-500/40 transition-all appearance-none cursor-pointer hover:bg-gray-750"
        >
